...
#define OPCODE_SETACTORTILECOLOR      0b0001U
#define OPCODE_SETBACKGROUNDTILECOLOR 0b0010U
#define OPCODE_SETACTORTILEID         0b0011U
#define OPCODE_SETBACKGROUNDTILEID    0b0100U
#define OPCODE_MOVEACTORPOSITION      0b0101U
